...
class GF_Field_HPSach extends GF_Field
{
    ...
    public function validate($value, $form)
    {
        ...
        if (empty($account_name)) {
            ...
            $this->validation_message = empty($this->errorMessage)
                ? esc_html__(
                    'Please enter your account holder name. All fields required.',
                    'gravityforms'
                )
                : $this->errorMessage;
            ...
            $this->validation_message = empty($this->errorMessage)
                ? esc_html__(
                    'Please enter your account number. All fields required.',
                    'gravityforms'
                )
                : $this->errorMessage;
            ...
            $this->validation_message = empty($this->errorMessage)
                ? esc_html__(
                    'Please enter your rounting number. All fields required.',
                    'gravityforms'
                )
                : $this->errorMessage;
            ...
            $this->validation_message = empty($this->errorMessage)
                ? esc_html__(
                    'Please select an account type. All fields required.',
                    'gravityforms'
                )
                : $this->errorMessage;
            ...
            $this->validation_message = empty($this->errorMessage)
                ? esc_html__(
                    'Please select the type of check. All fields required.',
                    'gravityforms'
                )
                : $this->errorMessage;
    ...
    public function get_field_input($form, $value = '', $entry = null)
    {
        ...
        $class_suffix = isset($class_suffix) ? $class_suffix : '';
        $field_id = isset($field_id) ? $field_id : '';
        $card_icons = isset($card_icons) ? $card_icons : '';
        $sub_label_class_attribute = isset($sub_label_class_attribute) ? $sub_label_class_attribute : '';
        $account_name_label = isset($account_name_label) ? $account_name_label : '';
        $disabled_text = isset($disabled_text) ? $disabled_text : '';
        $account_number_label = isset($account_number_label) ? $account_number_label : '';
        $routing_number_label = isset($routing_number_label) ? $routing_number_label : '';
        $account_type_label = isset($account_type_label) ? $account_type_label : '';
        $check_type_label = isset($check_type_label) ? $check_type_label : '';
